...
### **6. Global Store Closures Tab**
- Add dates (ranges) when entire store is closed (holidays, vacation)
- List of closed dates with reopen button
- Affects all products simultaneously
